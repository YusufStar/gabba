...
const CustomTable = ({
    ...
    return (<div className=" h-full flex flex-col gap-4">
        ...
        <div className="flex flex-wrap items-center w-full gap-4">
            ...
            {addData && <Dialog open={openAddModal} onOpenChange={setOpenAddModal}>
                        ...
                        return (/* TableRow -> tr */
                            <TableRow key={dt_idx}>
                                ...
                                {table.getHeaders().map((col, col_idx) => {
                                    ...
                                    return (<TableCell className="whitespace-nowrap" key={col_idx}>{CustomComponent ?
                                        <CustomComponent {...col} {...dt}
                                                         setData={setData}/> : dt[col.dt_name + lang?.code ?? ""] ?? dt[col.dt_name]} </TableCell>)
                                })}
                                <TableCell>
                                    <Dialog>
                                        <DropdownMenu>
                                        ...
                                        <DialogContent className="lg:max-w-screen-lg overflow-y-scroll max-h-screen">
                                            ...
                                            >
                                                <div className="w-full flex items-start pr-8">
                                                    <DialogHeader>
                                                        <DialogTitle>Add Data</DialogTitle>
                                                        <DialogDescription>Click add when you're
                                                    ...
                                                    {columns
                                                        ...
                                                        .map((column, col_index) => {
                                                            ...
                                                            >
                                                                ...
                                                                <Input
                                                                    onChange={(event) => setUpdateDataState((prevState) => ({
                                                                        ...prevState, [columnKey]: event.target.value,
                                                                    }))}
                                                                    type={column?.type}
